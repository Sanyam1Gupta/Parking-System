...
const RecalculateConfirmation = props => {
    ...
    <>
      ...
      <DialogContent className="dialog-content-wrapper">
        <Grid container justify="center">
          ...
          >
            Do you want to delete the previous planned Financial Immunity Goal
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(RecalculateConfirmation),
);
